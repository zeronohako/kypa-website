      ...
      <section className="py-12 mb-12 rounded-lg shadow-md" style={{ backgroundColor: '#ecf7f3' }}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 px-6">
          <div className="bg-white p-6 rounded-lg shadow text-center">
            ...
            <p className="text-gray-600">We believe in creating a welcoming environment for all young players, regardless of their skill level or background.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow text-center">
          ...
          <div className="bg-white p-6 rounded-lg shadow text-center">
            ...
            <p className="text-gray-600">We actively engage with multicultural family centers and hearing-impaired support centers to share the joy of pickleball and give back to the community.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12 max-w-xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <input type="email" id="email" name="email" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="your@email.com" required />
          </div>
          <div>
            <label htmlFor="school" className="block text-gray-700 text-sm font-bold mb-2">School name and Grade:</label>
            <input type="text" id="school" name="school" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="e.g., KIS, 11th Grade" />
          </div>
          <div>
