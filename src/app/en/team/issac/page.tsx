    ...
    <div className="container mx-auto py-12 px-4">
      ...
      <div className="flex flex-col md:flex-row items-start gap-12 mb-20">
        ...
        <div className="w-full md:w-2/3">
          <h1 className="text-5xl font-bold mb-2">Issac</h1>
      ...
      <section className="mb-20 text-center">
        <h3 className="text-3xl font-semibold mb-6">Meet Issac</h3>
        <div className="w-full max-w-4xl mx-auto">
          <video
            ...
            preload="metadata"
          >
            <source src="/videos/Issac-intro.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
          <p className="text-md text-gray-700 leading-relaxed">
            Issac inspires volunteerism and grows pickleball access for underserved youth in Korea.
          </p>
        </div>
      </section>
